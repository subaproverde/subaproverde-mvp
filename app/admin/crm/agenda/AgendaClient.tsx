...
function EmptyState({ title, detail }: { title: string; detail: string }) { return <div className="mx-auto my-10 max-w-md rounded-xl border border-dashed border-[var(--agenda-border)] px-6 py-10 text-center"><CalendarCheck2 className="mx-auto h-7 w-7 text-emerald-400" /><div className="agenda-title mt-3 text-sm font-semibold">{title}</div><div className="agenda-muted mt-1 text-xs">{detail}</div></div>; }
