...
export default function SellerDashboardPage() {
  ...
  const sellerId = String(params?.id ?? ""); // ✅ fonte da verdade
  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      // ✅ só garante que está logado (não busca seller padrão!)
  ...
  }, [sellerId]); // ✅ ESSA LINHA É A CHAVE: muda seller => recarrega tudo
